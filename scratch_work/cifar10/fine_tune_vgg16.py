...
train_images = np.array([tf.image.resize(img, [112, 112]).numpy() for img in train_images])
test_images = np.array([tf.image.resize(img, [112, 112]).numpy() for img in test_images])
